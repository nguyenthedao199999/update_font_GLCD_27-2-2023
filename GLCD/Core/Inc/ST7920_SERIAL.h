...
//void ST7920_GraphicsDisplayString(unsigned char line, char* str);

//void LCD_GraphicsDisplayString(unsigned char line, char* str, uint8_t count);

void SendcharGLCD(uint8_t x, uint8_t y, char Character);

void SendstringGLCD(uint8_t x, uint8_t y, char * string);

//void ST7920_GraphicLCD_Font_Print(uint8_t x,uint8_t y,char * String);
